                ...
                <div className="container mx-auto px-4">
                    <div className="pb-12 flex flex-wrap items-center justify-between border-b border-gray-800">
                        <div className="w-full lg:w-1/5 mb-12 lg:mb-4">
                            <Link className="inline-block text-3xl font-bold leading-none" href="#">
                        ...
                        <div className="w-full lg:w-auto">
                            <ul className="flex flex-wrap lg:space-x-5 items-center">
                                ...
                                <li className="hidden md:block">
                                    <svg className="mx-4 w-4 h-4 text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li>
                                    <Link className="lg:text-sm text-gray-400 hover:text-gray-300" href={"/testimonial"}>
                                        Testimonials
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <div className="mt-8 flex flex-wrap justify-between items-center">
                        ...
                        <div className="mb-4 lg:mb-0 order-first lg:order-last">
                            <Link className="inline-block mr-2 p-2 bg-gray-800 hover:bg-gray-700 rounded" href="#">
